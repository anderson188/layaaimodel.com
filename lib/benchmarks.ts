/** Transcribed from upstream BENCHMARKS.md and the README comparison table. Do not edit figures. */
...
export const routedVsJev = {
  ...
  headers: ["", "Jev 1.13.0", "Laya (routed)", ""],
  rows: [
...
export const languages = {
  ...
  headers: ["lang", "laya", "laya-multilingual", "Δ", "laya ECE", "multilingual ECE"],
  rows: [
...
export const englishVsRest = {
  caption: "BENCHMARKS.md — English vs the rest. Bold marks the higher accuracy in the source table.",
  headers: ["task", "laya", "laya-multilingual"],
  rows: [
...
export const themes = {
  ...
  headers: ["theme", "laya", "laya-multilingual", "laya-typed-decisions", "data"],
  rows: [
...
export const publicDatasets = {
  caption: "BENCHMARKS.md — public datasets where Jev numbers exist. Jev column is published, not remeasured here.",
  headers: ["dataset", "laya", "laya-multilingual", "laya-typed-decisions", "Jev (published)"],
  rows: [
...
export const workflows = {
  caption: "BENCHMARKS.md — laya-typed-decisions accuracy by workflow.",
  headers: ["workflow", "laya-typed-decisions"],
  rows: [
...
export const speed = {
  caption: "BENCHMARKS.md — speed on a Tesla T4. Bold marks the faster cell in the source.",
  headers: ["questions per call", "laya", "laya-multilingual"],
  rows: [
    ["1", "39.5 ms", "**32.8 ms**"],
    ["5", "84.5 ms", "**40.1 ms**"],
    ["10", "158.6 ms", "**72.3 ms**"],
...
export const calibration = {
  caption: "BENCHMARKS.md — mean ECE as shipped, then after temperature refit. Lower is better.",
  headers: ["", "as shipped", "temperature refit"],
  rows: [
    ["laya", "0.466", "**0.081**"],
...
export const optionOrder = {
  ...
  headers: ["suite", "laya", "laya-multilingual"],
  rows: [
...
export const checkpoints = {
  caption: "README checkpoint table.",
  headers: ["", "encoder", "params", "context", "use it for"],
  rows: [
